...
impl AsEventCode for TheOtherMetricNameMetricDimension0 {
...
impl AsEventCode for TheProjectMetricDimensionASecondGroup {
  fn as_event_code(&self) -> u32 {
    *self as u32
  }
}
...
impl AsEventCode for TheProjectMetricDimension2 {
  fn as_event_code(&self) -> u32 {
    *self as u32
  }
}
...
impl AsEventCode for TheProjectMetricDimensionFirst {
  fn as_event_code(&self) -> u32 {
    *self as u32
  }
}
...
impl AsEventCode for TheProjectMetricDimensionSecond {
  fn as_event_code(&self) -> u32 {
    *self as u32
  }
}
