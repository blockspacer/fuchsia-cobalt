...
#ifndef COBALT_SRC_ALGORITHMS_FORCULUS_POLYNOMIAL_COMPUTATIONS_H_
#define COBALT_SRC_ALGORITHMS_FORCULUS_POLYNOMIAL_COMPUTATIONS_H_
...
#endif  // COBALT_SRC_ALGORITHMS_FORCULUS_POLYNOMIAL_COMPUTATIONS_H_
