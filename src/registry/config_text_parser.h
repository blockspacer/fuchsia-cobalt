...
#ifndef COBALT_SRC_REGISTRY_CONFIG_TEXT_PARSER_H_
#define COBALT_SRC_REGISTRY_CONFIG_TEXT_PARSER_H_
...
#endif  // COBALT_SRC_REGISTRY_CONFIG_TEXT_PARSER_H_
