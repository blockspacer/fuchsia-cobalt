...
Status EventAggregator::LogUniqueActivesEvent(uint32_t report_id, EventRecord* event_record) {
...
Status EventAggregator::LogCountEvent(uint32_t report_id, EventRecord* event_record) {
...
Status EventAggregator::LogElapsedTimeEvent(uint32_t report_id, EventRecord* event_record) {
...
Status EventAggregator::LogFrameRateEvent(uint32_t report_id, EventRecord* event_record) {
...
Status EventAggregator::LogMemoryUsageEvent(uint32_t report_id, EventRecord* event_record) {
