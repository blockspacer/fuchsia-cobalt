...
#ifndef COBALT_SRC_LIB_CRYPTO_UTIL_MAC_H_
#define COBALT_SRC_LIB_CRYPTO_UTIL_MAC_H_
...
bool HMAC(const byte *key, size_t key_len, const byte *data, size_t data_len, byte tag[TAG_SIZE]);
...
#endif  // COBALT_SRC_LIB_CRYPTO_UTIL_MAC_H_
