...
#ifndef COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_PARALLEL_BOOSTING_WITH_MOMENTUM_H_
#define COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_PARALLEL_BOOSTING_WITH_MOMENTUM_H_
...
#endif  // COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_PARALLEL_BOOSTING_WITH_MOMENTUM_H_
