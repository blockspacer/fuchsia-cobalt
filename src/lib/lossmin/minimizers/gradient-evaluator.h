...
#ifndef COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_GRADIENT_EVALUATOR_H_
#define COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_GRADIENT_EVALUATOR_H_
...
#endif  // COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_GRADIENT_EVALUATOR_H_
