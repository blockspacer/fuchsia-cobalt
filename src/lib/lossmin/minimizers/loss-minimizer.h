...
#ifndef COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_LOSS_MINIMIZER_H_
#define COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_LOSS_MINIMIZER_H_
...
#endif  // COBALT_SRC_LIB_LOSSMIN_MINIMIZERS_LOSS_MINIMIZER_H_
